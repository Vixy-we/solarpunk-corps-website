        ...
        <div id="alumni-top" className="min-h-screen bg-[#FDFBF7] dark:bg-background text-gray-800 dark:text-foreground flex flex-col font-sans">
            ...
            <section className="max-w-6xl mx-auto px-6 py-12">
                <div className="flex flex-wrap justify-center gap-6">
                    ...
                    {/* Card 1: Mentorship */}
                    <div
                        className="bg-white dark:bg-card p-8 rounded-2xl border border-gray-100 dark:border-border hover:-translate-y-1 hover:shadow-xl transition-all cursor-pointer group w-full md:w-[calc(50%-12px)] lg:w-[calc(25%-18px)]"
                        onClick={() => handlePathwaySelect('mentorship')}
                    >
                        ...
                        <p className="text-sm text-gray-500 dark:text-muted-foreground leading-relaxed mb-4">
                            We are starting from scratch. Help us avoid the pitfalls you faced. We need advisors and technical mentors.
                        </p>
                        <span className="text-blue-600 dark:text-blue-400 text-sm font-semibold flex items-center">
                            Share Wisdom <span className="ml-1 transition-transform group-hover:translate-x-1">→</span>
                        </span>
                    </div>
                    ...
                    <div
                        className="bg-white dark:bg-card p-8 rounded-2xl border border-gray-100 dark:border-border hover:-translate-y-1 hover:shadow-xl transition-all cursor-pointer group w-full md:w-[calc(50%-12px)] lg:w-[calc(25%-18px)]"
                        onClick={() => handlePathwaySelect('material')}
                    >
                        ...
                        <p className="text-sm text-gray-500 dark:text-muted-foreground leading-relaxed mb-4">
                            We are building our inventory from zero. Your old laptops, tools, or sensors can kickstart our first lab.
                        </p>
                        <span className="text-amber-600 dark:text-amber-400 text-sm font-semibold flex items-center">
                            Donate Gear <span className="ml-1 transition-transform group-hover:translate-x-1">→</span>
                        </span>
                    </div>
                    ...
                    <div
                        className="bg-white dark:bg-card p-8 rounded-2xl border border-gray-100 dark:border-border hover:-translate-y-1 hover:shadow-xl transition-all cursor-pointer group w-full md:w-[calc(50%-12px)] lg:w-[calc(25%-18px)]"
                        onClick={() => handlePathwaySelect('network')}
                    >
                        ...
                        <p className="text-sm text-gray-500 dark:text-muted-foreground leading-relaxed mb-4">
                            Connect this new generation to the industry. Help arrange our first industrial visits or internships.
                        </p>
                        <span className="text-purple-600 dark:text-purple-400 text-sm font-semibold flex items-center">
                            Connect Us <span className="ml-1 transition-transform group-hover:translate-x-1">→</span>
                        </span>
                    </div>
                    ...
                    <div
                        className="bg-white dark:bg-card p-8 rounded-2xl border border-gray-100 dark:border-border hover:-translate-y-1 hover:shadow-xl transition-all cursor-pointer group w-full md:w-[calc(50%-12px)] lg:w-[calc(25%-18px)]"
                        onClick={() => handlePathwaySelect('financial')}
                    >
                        ...
                        <p className="text-sm text-gray-500 dark:text-muted-foreground leading-relaxed mb-4">
                            New clubs have zero budget. Small contributions help us buy our first microcontroller or server.
                        </p>
                        <span className="text-green-600 dark:text-green-400 text-sm font-semibold flex items-center">
                            Fuel the Start <span className="ml-1 transition-transform group-hover:translate-x-1">→</span>
                        </span>
                    </div>
                    ...
                    >
                        ...
                        <p className="text-sm text-gray-500 dark:text-muted-foreground leading-relaxed mb-4">
                            Fund CSR Initiatives Under Club Social Responsibility, we conduct plantation drives, teach underprivileged kids...
                        </p>
                        <span className="text-rose-600 dark:text-rose-400 text-sm font-semibold flex items-center">
                        ...
                        <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" className="w-full bg-gray-50 dark:bg-secondary border border-gray-200 dark:border-input rounded-lg px-4 py-3 focus:bg-white dark:focus:bg-background focus:ring-2 focus:ring-green-500 outline-none transition-all dark:text-foreground" placeholder="2012" />
                                </div>
                            </div>
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
                                    ...
                                    <label className="cursor-pointer">
                                        ...
                                        <div className="border-2 border-gray-200 dark:border-border peer-checked:border-blue-500 peer-checked:bg-blue-50 dark:peer-checked:bg-blue-900/20 rounded-lg p-3 text-center transition-all hover:bg-gray-50 dark:hover:bg-muted h-full flex flex-col items-center justify-center">
                                            ...
                                            <span className="text-xs font-bold text-gray-700 dark:text-foreground">Mentoring</span>
                                        </div>
                                    </label>
                                    ...
                                    <label className="cursor-pointer">
                                        ...
                                        <div className="border-2 border-gray-200 dark:border-border peer-checked:border-amber-500 peer-checked:bg-amber-50 dark:peer-checked:bg-amber-900/20 rounded-lg p-3 text-center transition-all hover:bg-gray-50 dark:hover:bg-muted h-full flex flex-col items-center justify-center">
                                            ...
                                            <span className="text-xs font-bold text-gray-700 dark:text-foreground">Equipping</span>
                                        </div>
                                    </label>
                                    ...
                                    <label className="cursor-pointer">
                                        ...
                                        <div className="border-2 border-gray-200 dark:border-border peer-checked:border-purple-500 peer-checked:bg-purple-50 dark:peer-checked:bg-purple-900/20 rounded-lg p-3 text-center transition-all hover:bg-gray-50 dark:hover:bg-muted h-full flex flex-col items-center justify-center">
                                            <span className="text-2xl mb-1">🤝</span>
                                            <span className="text-xs font-bold text-gray-700 dark:text-foreground">Connecting</span>
                                        </div>
                                    </label>
                                    ...
                                    <label className="cursor-pointer">
                                        ...
                                        <div className="border-2 border-gray-200 dark:border-border peer-checked:border-green-500 peer-checked:bg-green-50 dark:peer-checked:bg-green-900/20 rounded-lg p-3 text-center transition-all hover:bg-gray-50 dark:hover:bg-muted h-full flex flex-col items-center justify-center">
                                            <span className="text-2xl mb-1">🌱</span>
                                            <span className="text-xs font-bold text-gray-700 dark:text-foreground">Donating</span>
                                        </div>
                                    </label>
                            ...
                            <div>
                                ...
                                <input type="email" className="w-full bg-gray-50 dark:bg-secondary border border-gray-200 dark:border-input rounded-lg px-4 py-3 focus:bg-white dark:focus:bg-background focus:ring-2 focus:ring-green-500 outline-none transition-all dark:text-foreground" placeholder="you@company.com" />
                            </div>
